...
})({"78FX5":[function(require,module,exports,__globalThis) {
...
module.bundle.HMR_BUNDLE_ID = "58715bbfb31b741e";
"use strict";
...
},{}],"jfkqH":[function(require,module,exports,__globalThis) {
document.addEventListener("DOMContentLoaded", ()=>{
    ...
    function callRandomNumber() {
        ...
        calledNumberDisplay.textContent = `\u{1F3B2} Called Number: ${calledNumber}`;
        // Highlight called number on board
        document.querySelectorAll(".bingo-cell").forEach((cell)=>{
            if (cell.textContent === calledNumber.toString()) cell.classList.add("marked");
        });
    }
    // Initialize game
    renderBingoBoard();
...
},{}]},["78FX5","jfkqH"], "jfkqH", "parcelRequire7ca5", {})

//# sourceMappingURL=bingo.b31b741e.js.map
